...
function populateOptions(selector, packageName) {
    var versionRequestUrl = "https://azuresdkdocs.blob.core.usgovcloudapi.net/$web/" + SELECTED_LANGUAGE + "/" + packageName + "/versioning/versions"
...
function populateIndexList(selector, packageName) {
    var url = "https://azuresdkdocs.blob.core.usgovcloudapi.net/$web/" + SELECTED_LANGUAGE + "/" + packageName + "/versioning/versions"
    var latestGAUrl = "https://azuresdkdocs.blob.core.usgovcloudapi.net/$web/" + SELECTED_LANGUAGE + "/" + packageName + "/versioning/latest-ga"
    var latestPreviewUrl = "https://azuresdkdocs.blob.core.usgovcloudapi.net/$web/" + SELECTED_LANGUAGE + "/" + packageName + "/versioning/latest-preview"
...
function getPackageUrl(language, package, version) {
    return "https://azuresdkdocs.blob.core.usgovcloudapi.net/$web/" + language + "/" + package + "/" + version + "/index.html"
}
